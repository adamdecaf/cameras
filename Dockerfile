...
# Adopted from https://github.com/adinriv/docker-opencv
# This fork has updated versions and only installed required packages
...
RUN apt-get -y update -qq && \
    apt-get -y install \
            ...
            # Required
            build-essential cmake git pkg-config libatlas-base-dev libgtk2.0-dev libavcodec-dev libavformat-dev libswscale-dev \
            # Optional
            libtbb2 libtbb-dev libjpeg-dev libpng-dev libtiff-dev libv4l-dev libdc1394-22-dev \qt4-default \
            ...
            # Cleanup
            # apt-get remove wget unzip git cmake && \
